...
<div class="weui-form">
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title" id="show_msg">正在跳转支付...</h2>
    </div>
    <div class="weui-form__opr-area" style="display:none" id="close_btn">
    ...
    WeixinJSBridge.invoke(
        ...
        function(res){
            if(res.err_msg == 'get_brand_wcpay_request:ok') {
                $("#show_icon").html('<i class="weui-icon-success weui-icon_msg"></i>');
                $("#show_msg").html('{lang unifiedpay:payment_succeed}');
                $("#close_btn").show();
            }
        }
    );
