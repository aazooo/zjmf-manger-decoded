                                ...
                                <div class="tab-content">
                                    {if $Login.allow_login_email || $Login.allow_id}
                                        <div id="email" class="tab-pane  {if $Get.action=="email" || !$Get.action}active{/if}" role="tabpanel">
                                            <form method="post" action="/loginAccessToken?action=email">
                                    ...
                                    {if $Login.allow_login_phone}
                                        <div id="phone" class="tab-pane {if ($Login.allow_login_phone==1 && $Login.allow_login_email == 0  && $Login.allow_id == 0) || $Get.action=="phone" || $Get.action=="phone_code"}active{/if}" role="tabpanel">
                                            <form method="post" action="/loginAccessToken?action=phone" >
                                                <input type="hidden" class="form-control" name="redirect_url" value="{$redirect_url}">
                                                <div class="form-group">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div onclick="phoneCheckToken(this,'allow_login_phone_captcha')" class="text-primary mr-0 pointer" {if $Get.action=="phone_code"} style="display:none;" {/if}>
                                                        {$Lang.verification_code_login}
                                                    </div>
                                                    <div onclick="phoneCheckToken(this,'allow_login_code_captcha')" class="text-primary mr-0 pointer" {if $Get.action!="phone_code"} style="display:none;" {/if}>
                                                        {$Lang.password_login}
                                                    </div>
                                                </div>
                                                <div class="mt-3">
