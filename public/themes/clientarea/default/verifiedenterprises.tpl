		...
		<div class="row justify-content-center">
			<div class="col-10">
				...
				<div class="verified_not_certified">
					<div class="not_certified_title">
						{$Lang.not_name_authentication}
					</div>
					<div class="not_certified_text">
						...
						<div class="col-6">
							<div class="type-item">
								...
								<ul class="list-unstyled type-info">
									<li><i class="fas fa-check-circle"></i> {$Lang.examine_immediate}</li>
									<li><i class="fas fa-check-circle"></i> {$Lang.upgrade_enterprise_user}</li>
								</ul>
								<a href="#" class="btn btn-primary btn-block waves-effect waves-light">{$Lang.certification_now}</a>
							</div>
						</div>
						<div class="col-6">
							<div class="type-item">
