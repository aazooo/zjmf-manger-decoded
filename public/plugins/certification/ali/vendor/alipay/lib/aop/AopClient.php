        ...
        */
        public function pageExecute($request,$httpmethod = "POST") {
            ...
            if (method_exists($request,"getNeedEncrypt") &&$request->getNeedEncrypt()){
                ...
                // 执行加密
                $enCryptContent = alipy_encrypt($apiParams['biz_content'], $this->encryptKey);
        ...
        protected function buildRequestForm($para_temp) {
            $sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$this->gatewayUrl."?charset=".trim($this->postCharset)."' method='POST'  target='_blank' >";
            ...
            $sHtml = $sHtml."<input class='btn btn-success' type='submit' value='' style='display:none'/></form>";
            # 不立即跳转
        ...
        private function encryptJSONSignSource($request, $responseContent) {
            ...
            $bizContent = alipy_decrypt($parsetItem->encryptContent, $this->encryptKey);
